...
slid<-slidingwin(baseline=lm(mean.date~1, data=mobu), xvar=list(TempMean=cov$air_mean, GDD=cov$gdd, TempVar=cov$air_var, Rain=cov$precip_sum), cdate=cov$date, bdate=mobu$date.mean, type = "absolute", refday=c(24, 9), range=c(114,0), func="lin", stat="mean", cinterval="day")
...
#randomized2<-randwin(repeats = 100,     
#                     baseline = lm(sd.low~1, data = mobu),
#                     xvar = list(GDD=cov$gdd),
#                     type = "absolute", 
#                     range=c(97,0),
...
slid<-slidingwin(baseline=lm(doy_abund50~1, data=mobu), xvar=list(TempMean=cov$air_mean, GDD=cov$gdd, TempVar=cov$air_var, Rain=cov$precip_sum), cdate=cov$date, bdate=mobu$doy.abund50, type = "absolute", refday=c(6, 9), range=c(97,0), func="lin", stat="mean", cinterval="day")
...
slid<-slidingwin(baseline=lm(doy_peak1~1, data=mobu), xvar=list(TempMean=cov$air_mean, GDD=cov$gdd, TempVar=cov$air_var, Rain=cov$precip_sum), cdate=cov$date, bdate=mobu$doy.peak1, type = "absolute", refday=c(26, 9), range=c(117,0), func="lin", stat="mean", cinterval="day")
...
slid<-slidingwin(baseline=lm(doy_peakmean~1, data=mobu), xvar=list(TempMean=cov$air_mean, GDD=cov$gdd, TempVar=cov$air_var, Rain=cov$precip_sum), cdate=cov$date, bdate=mobu$doy.peakmean, type = "absolute", refday=c(4, 10), range=c(125,0), func="lin", stat="mean", cinterval="day")
...
#randomized2<-randwin(repeats = 10,     
#                     baseline = lm(doy_mean~1, data = mobu),
#                     xvar = list(GDD=cov$gdd),
#                     type = "absolute", 
#                     range=c(125,0),
#                     stat = c("mean"),
