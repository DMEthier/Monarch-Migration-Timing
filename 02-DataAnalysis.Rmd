...
#Not part of the formal model test. Just for exploration. 

```{r Globalmodels}

modelG<- lm(mean.date ~ June_temp+July_temp+August_temp+September_temp+October_temp+June_precip+July_precip+August_precip+September_precip+October_precip+Summer_precip+survey_year, data=dat)
summary(modelG)
#October_temp sig

modelG1<- lm(weighted.sd ~ June_temp+July_temp+August_temp+September_temp+October_temp+June_precip+July_precip+August_precip+September_precip+October_precip+Summer_precip+survey_year, data=dat)
summary(modelG1)
#Nothing sig

modelG2<- lm(quant90 ~ June_temp+July_temp+August_temp+September_temp+October_temp+June_precip+July_precip+August_precip+September_precip+October_precip+Summer_precip+survey_year, data=dat)
summary(modelG2)
#September_temp sig

modelG3<- lm(doy_abund50 ~ June_temp+July_temp+August_temp+September_temp+October_temp+June_precip+July_precip+August_precip+September_precip+October_precip+Summer_precip+survey_year, data=dat)
summary(modelG2)
#September_temp sig

modelG4<- lm(doy_peak1 ~ June_temp+July_temp+August_temp+September_temp+October_temp+June_precip+July_precip+August_precip+September_precip+October_precip+Summer_precip+survey_year, data=dat)
summary(modelG2)
#September_temp sig

modelG5<- lm(doy_peakmean ~ June_temp+July_temp+August_temp+September_temp+October_temp+June_precip+July_precip+August_precip+September_precip+October_precip+Summer_precip+survey_year, data=dat)
summary(modelG2)
#September_temp sig
...
#June temp, August precip, summer precip, > 0.3

sd_full<-lm(weighted.sd~June_temp+August_precip+Summer_precip+survey_year, data=sd)
summary(sd_full)
plot(sd_full)
